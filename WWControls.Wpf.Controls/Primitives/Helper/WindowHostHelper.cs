...
namespace WWControls.Wpf.Controls.Primitives
{
    ...
    /// editor, Column Chooser, <see cref="Primitives.WWMessageBox"/>): applies the
    /// <see cref="PrimitiveThemeKeys.Window"/> chrome and wires the <see cref="SystemCommands"/>
    /// its caption buttons invoke — per window instance, so consumers don't need app-level class
    /// command bindings for the chrome to work.
    /// </summary>
    public static class WindowHostHelper
    {
        ...
        /// </summary>
        public static void ApplyDefaultChrome(Window host, FrameworkElement resourceScope)
        {
        ...
        /// </summary>
        public static void WireSystemCommands(Window host)
        {
