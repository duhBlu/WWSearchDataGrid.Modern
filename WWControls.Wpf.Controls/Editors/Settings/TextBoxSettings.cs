...
namespace WWControls.Wpf.Controls.Editors.Settings
{
    ...
    /// </para>
    /// </remarks>
    public class TextBoxSettings : BaseEditorSettings
    {
        /// <summary>
        ...
        public static readonly DependencyProperty MaskProperty =
            DependencyProperty.Register(nameof(Mask), typeof(string), typeof(TextBoxSettings),
        ...
        public static readonly DependencyProperty MaskTypeProperty =
            DependencyProperty.Register(nameof(MaskType), typeof(MaskType), typeof(TextBoxSettings),
        ...
        public static readonly DependencyProperty UseMaskAsDisplayFormatProperty =
            DependencyProperty.Register(nameof(UseMaskAsDisplayFormat), typeof(bool), typeof(TextBoxSettings),
        ...
        {
            var factory = new FrameworkElementFactory(typeof(WWTextBox));
            ...
            factory.SetValue(WWTextBox.TextAlignmentProperty, column.TextAlignment);
            ...
            // Binding.StringFormat) and the edit-time mask. WWTextBox owns the mask wiring on its
            ...
            if (!string.IsNullOrEmpty(effectiveMask))
            {
                ...
                factory.SetValue(WWTextBox.MaskTypeProperty, effectiveMaskType);
                factory.SetValue(WWTextBox.MaskProperty, effectiveMask);
            }
            factory.SetBinding(WWEditorBase.ValueProperty, editBinding);
            SuppressValidationErrorAdorner(factory);
        ...
        /// <summary>
        /// Filter-row editor: the same <see cref="WWTextBox"/> the cell uses, bound to the host's
        ...
        {
            var editor = new WWTextBox { ShowBorder = false };
            BindingOperations.SetBinding(editor, WWEditorBase.ValueProperty, new Binding(nameof(IFilterEditorHost.SearchText))
            {
                Source = host,
