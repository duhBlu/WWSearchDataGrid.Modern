...
namespace WWControls.Wpf.Editors
{
    ...
    /// </summary>
    public class WWReorderableListBoxBehavior : Behavior<WWReorderableListBox>
    {
        ...
        public static readonly DependencyProperty ItemDragStartingCommandProperty =
            DependencyProperty.Register(nameof(ItemDragStartingCommand), typeof(ICommand),
                typeof(WWReorderableListBoxBehavior), new PropertyMetadata(null));
    ...
    #region WWReorderableListBox CustomControl
    
    /// <summary>
    /// A ListBox with built-in drag-and-drop reordering support
    /// </summary>
    public class WWReorderableListBox : ListBox
    {
        ...
        public static readonly DependencyProperty EnableDragDropProperty =
            DependencyProperty.Register(nameof(EnableDragDrop), typeof(bool), typeof(WWReorderableListBox),
                new PropertyMetadata(true));

        public static readonly DependencyProperty AutoScrollEdgeProperty =
            DependencyProperty.Register(nameof(AutoScrollEdge), typeof(double), typeof(WWReorderableListBox),
                new PropertyMetadata(28.0));

        public static readonly DependencyProperty AutoScrollMinSpeedProperty =
            DependencyProperty.Register(nameof(AutoScrollMinSpeed), typeof(double), typeof(WWReorderableListBox),
                new PropertyMetadata(0.5));

        public static readonly DependencyProperty AutoScrollMaxSpeedProperty =
            DependencyProperty.Register(nameof(AutoScrollMaxSpeed), typeof(double), typeof(WWReorderableListBox),
                new PropertyMetadata(2.0));

        public static readonly DependencyProperty MarginAnimationDurationProperty =
            DependencyProperty.Register(nameof(MarginAnimationDuration), typeof(int), typeof(WWReorderableListBox),
        ...
        public static readonly DependencyProperty AdornerOpacityProperty =
            DependencyProperty.Register(nameof(AdornerOpacity), typeof(double), typeof(WWReorderableListBox),
        ...
        public static readonly RoutedEvent ItemDragStartingEvent =
            EventManager.RegisterRoutedEvent(nameof(ItemDragStarting), RoutingStrategy.Bubble,
                typeof(EventHandler<ItemDragEventArgs>), typeof(WWReorderableListBox));
        ...
        public static readonly RoutedEvent ItemReorderedEvent =
            EventManager.RegisterRoutedEvent(nameof(ItemReordered), RoutingStrategy.Bubble,
                typeof(EventHandler<ItemReorderedEventArgs>), typeof(WWReorderableListBox));
        ...
        static WWReorderableListBox()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(WWReorderableListBox),
                new FrameworkPropertyMetadata(typeof(WWReorderableListBox)));
        }

        public WWReorderableListBox()
        {
            AllowDrop = true;
        ...
        {
            if (d is WWReorderableListBox listBox)
            {
    ...
    #endregion WWReorderableListBox CustomControl
