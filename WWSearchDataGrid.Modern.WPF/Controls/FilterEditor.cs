...
namespace WWSearchDataGrid.Modern.WPF
{
    ...
    public class FilterEditor : Control
    {
        ...
        public static readonly DependencyProperty OwnerGridProperty =
            DependencyProperty.Register(nameof(OwnerGrid), typeof(SearchDataGrid), typeof(FilterEditor),
                new PropertyMetadata(null));

        public static readonly DependencyProperty RootGroupProperty =
            DependencyProperty.Register(nameof(RootGroup), typeof(FilterGroupNode), typeof(FilterEditor),
                new PropertyMetadata(null));

        public static readonly DependencyProperty AvailableColumnsProperty =
            DependencyProperty.Register(nameof(AvailableColumns), typeof(ObservableCollection<GridColumn>), typeof(FilterEditor),
                new PropertyMetadata(null));
        ...
        public FilterEditor()
        {
            DefaultStyleKey = typeof(FilterEditor);
        }
        ...
        /// up the library's custom chrome via <see cref="SdgThemeKeys.FilterEditorWindow"/> —
        ...
        public static bool? ShowDialog(SearchDataGrid grid)
        {
            ...
            var defaultStyle = editor.TryFindResource(SdgThemeKeys.FilterEditorWindow) as Style;
