...
namespace WWSearchDataGrid.Modern.WPF
{
    ...
    /// <see cref="SdgIconKeys"/> so a single resource serves every state (default / hover / pressed /
    /// disabled) of every button, driven by the host control's <see cref="Control.Foreground"/>.
    /// </summary>
    /// <remarks>
    /// Usage inside a control template:
    /// <code>
    /// &lt;sdg:SdgIcon IconSource="{StaticResource {x:Static sdg:SdgIconKeys.IconClose}}"
    ...
    /// mutated — each <see cref="SdgIcon"/> owns its tinted clone.
    ///
    ...
    /// <see cref="Image"/>.</para>
    /// </remarks>
    public class SdgIcon : Image
    {
        /// <summary>Source <see cref="DrawingImage"/> resource — typically a <see cref="SdgIconKeys"/> entry.</summary>
