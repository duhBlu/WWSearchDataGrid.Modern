    ...
    public partial class ColumnFilterControl
    {
        private void OnCheckboxPreviewKeyDown(object sender, KeyEventArgs e)
        {
            try
            {
                ...
                {
                    // PART_FilterCheckBox is a standalone template part outside the text/editor
                    // key path; its Escape is handled here. ClearSearchTextAndTemporaryFilter
                    // routes through ResetCheckboxToInitialState for the checkbox branch.
