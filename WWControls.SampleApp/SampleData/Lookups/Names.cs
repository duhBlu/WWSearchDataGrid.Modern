namespace WWControls.SampleApp.SampleData.Lookups
{
    internal static class Names
    {
        ...
        public static readonly string[] EmployeeNames =
        {
        ...
        public static readonly string[] SalesReps =
        {
        ...
        {
            "Alice", "Bob", "Carol", "Dan", "Erin", "Frank", "Grace", "Henry", "Iris", "Jack",
            "Kate", "Liam", "Mia", "Noah", "Olivia", "Paul", "Quinn", "Riley", "Sara", "Tom",
            "Uma", "Victor", "Wendy", "Xavier", "Yasmin", "Zach"
        };

        public static readonly string[] LastNames =
        {
            "Anderson", "Brown", "Carter", "Doyle", "Edwards", "Foster", "Garcia", "Hayes",
            "Ito", "Johnson", "Kim", "Lopez", "Morris", "Nguyen", "O'Brien", "Park",
            "Quinn", "Reyes", "Smith", "Taylor", "Underwood", "Vasquez", "Walsh", "Xu", "Young", "Zhao"
        };

        public static readonly string[] VendorNames =
        {
            "Acme Hardware", "Bluebird Supply", "Coastal Distributors", "Delta Industrial",
            "Evergreen Mfg", "Foundry Source", "Granite State Goods", "Harbor Tools",
            "Ironclad Materials", "Junction Co"
        };

        public static readonly string[] Regions = { "West", "Central", "East", "North", "South" };
    }
}
