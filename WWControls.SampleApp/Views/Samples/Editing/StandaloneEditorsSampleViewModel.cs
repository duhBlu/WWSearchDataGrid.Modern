...
{
    /// <summary>
    /// Backs the standalone-editor sample: each of the five editor controls (WWTextEdit, WWSpinEdit,
    /// WWComboEdit, WWDateEdit, WWCheckEdit) is used directly on a form — no grid — with its value
    /// echoed back to prove the two-way Value/IsChecked binding round-trips and that the controls are
    /// genuinely grid-agnostic.
    /// </summary>
    public partial class StandaloneEditorsSampleViewModel : ObservableObject
    {
        // WWTextEdit — the chrome story (flat vs bordered vs masked vs read-only).
        [ObservableProperty]
        ...
        /// <summary>Items for the standalone WWComboEdit.</summary>
