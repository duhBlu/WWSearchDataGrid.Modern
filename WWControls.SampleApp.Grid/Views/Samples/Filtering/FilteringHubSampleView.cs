...
using WWControls.SampleApp.Grid.Controls;

namespace WWControls.SampleApp.Grid.Views.Samples.Filtering
{
    // The app's root namespace ends in ".Grid", which shadows the WPF panel type for unqualified
    // references. The alias must sit inside the namespace to win over that enclosing-namespace lookup.
