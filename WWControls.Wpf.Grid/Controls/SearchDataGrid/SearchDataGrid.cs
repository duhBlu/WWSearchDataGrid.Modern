...
namespace WWControls.Wpf.Grids
{
    ...
    public partial class SearchDataGrid : DataGrid, IEditingGridHost
    {
        ...
        public SearchDataGrid() : base()
        {
            ...
            // Initialize the Bands collection (same seeding convention). Populated bands are
            // flattened into GridColumns at load — see SearchDataGrid.Bands.cs.
            InitializeBands();
        ...
        private void OnSearchDataGridLoaded(object sender, RoutedEventArgs e)
        {
            ...
            {
                // Flatten any declared Bands into GridColumns first so band-declared columns are
                // generated by the normal pipeline; no-op when no bands are declared.
                FlattenBandsIntoGridColumns();
