...
{
    /// <summary>
    /// Backs the auto-filter-row options playground. Maintains one
    ...
    /// AutoFilterRowClearButtonMode, ShowCriteriaInAutoFilterRow) bind directly to the grid via
    ...
    public sealed partial class OptionsPlaygroundSampleViewModel : SampleViewModelBase
    {
        ...
        public IReadOnlyList<AutoFilterRowClearButtonMode> AutoFilterRowClearButtonModeChoices { get; } = new[]
        {
            AutoFilterRowClearButtonMode.Never,
            AutoFilterRowClearButtonMode.Always,
            AutoFilterRowClearButtonMode.Display,
            AutoFilterRowClearButtonMode.Edit,
        };
    ...
    /// <summary>
    /// Tri-state label/value pair for the <c>ShowCriteriaInAutoFilterRow</c> override combobox.
