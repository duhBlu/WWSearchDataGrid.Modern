...
namespace WWSearchDataGrid.Modern.SampleApp.Views.Samples.DataBinding
{
    ...
    /// a <c>ComboBoxEditSettings.ItemsSource</c>. Keeps the WPF EditSettings construction in the
    ...
    public sealed partial class BindingToDynamicObjectSampleViewModel : SampleViewModelBase
    {
        ...
        /// <c>ComboBoxEditSettings</c> over the returned choices — then adds it to the grid.
        /// </summary>
